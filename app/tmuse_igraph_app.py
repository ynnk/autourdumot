...
#TODO: descrption des graphs peut etre plus chiader...
graphs = {
    "jdmsyn": {
        "path": os.path.join( BASEDIR,"Graphs/jdm/fr.N.JDM-01282014-v1-e5-s_avg.pickle"),
    },
    #"jdmasso": {
    #    "path": os.path.join(BASEDIR, "Graphs/jdm/fr.JDM-01282014-v1-e0-s_avg.pickle"),
    #},
    "dsv": {
    ...
    #},
    "ctx_adj": {
        "path": os.path.join(BASEDIR,"Graphs/frantext/context/triples_frantext_ADJ_f3.graphmlz"),
        "engine_builder": lexical_bigraph_engine,
    },
}
